    ...
    : AudioProcessorEditor (&p), processor (p)
{
    ...
    SineSlider.setSliderStyle(Slider::SliderStyle::LinearHorizontal);
...
//    g.drawFittedText ("Threshold (dB)", 30, 170, 100, 25, Justification::centred, 1);
    g.drawFittedText ("Pitch shift (cents)", 100, 170, 100, 25, Justification::centred, 1);
...
//    thresholdSlider.setBounds(-20,20,200,150);
    pitchSlider.setBounds(50,20,200,150);
